...
export const CATEGORIES: Category[] = [
  ...
  { id: 'air-purifier', title: 'Air Purifier', description: 'Sensor cleaning and filter replacement.', imageUrl: 'https://images.unsplash.com/photo-1585659722982-796ca5cca2a0?auto=format&fit=crop&q=80&w=800', services: [{ id: 'ap-1', name: 'Filter Service', description: 'HEPA filter setup.', price: 349, estimatedTime: '30 mins', imageUrl: 'https://images.unsplash.com/photo-1585659722982-796ca5cca2a0?auto=format&fit=crop&q=80&w=800' }] },
