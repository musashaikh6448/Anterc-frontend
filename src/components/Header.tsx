        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center h-16 sm:h-24">
            ...
            <Link to="/" className="flex items-center gap-2 sm:gap-3 group">
              {theme?.logo?.imageUrl ? (
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-[1.25rem] overflow-hidden flex items-center justify-center transition-all duration-500 group-hover:shadow-xl">
                  <img
